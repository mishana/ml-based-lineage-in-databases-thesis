...
\BlankLine
 \For{$t \in D.tuples$}{
  ...
  \cmtcolor{\tcc{Now, perform a "smart" averaging over the word vectors of every word in $t$}}%\label{cmt}
  \vt = \WeightedAverage{\paramcolor{$word\_vectors_t$}}\;
}
\caption{Lineage vectors: initialization}\label{algo:init_approx}
\end{algorithm2e}